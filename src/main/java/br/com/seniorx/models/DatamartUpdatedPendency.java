...
public class DatamartUpdatedPendency {
	...
	public DatamartUpdatedPendency() {
	...
	public enum DatamartObjectTypeEnum {
		HOLIDAY("HOLIDAY"), TIMEZONE("TIMEZONE"), ACCESS_LEVEL("ACCESS_LEVEL"), AREA_CONTROLLED("AREA_CONTROLLED"),
		...
		public static DatamartObjectTypeEnum fromValue(String text) {
			byte b;
			int i;
			DatamartObjectTypeEnum[] arrayOfDatamartObjectTypeEnum;
			for (i = (arrayOfDatamartObjectTypeEnum = values()).length, b = 0; b < i;) {
				DatamartObjectTypeEnum datamartObjectTypeEnum = arrayOfDatamartObjectTypeEnum[b];
				if (String.valueOf(datamartObjectTypeEnum.value).equals(text))
					return datamartObjectTypeEnum;
				b++;
			}
			return null;
		}
		...
		public static class Adapter extends TypeAdapter<DatamartObjectTypeEnum> {
			public void write(JsonWriter jsonWriter, DatamartUpdatedPendency.DatamartObjectTypeEnum enumeration)
					throws IOException {
				jsonWriter.value(enumeration.getValue());
			}

			public DatamartUpdatedPendency.DatamartObjectTypeEnum read(JsonReader jsonReader) throws IOException {
				String value = jsonReader.nextString();
				return DatamartUpdatedPendency.DatamartObjectTypeEnum.fromValue(String.valueOf(value));
			}
		}
	}
