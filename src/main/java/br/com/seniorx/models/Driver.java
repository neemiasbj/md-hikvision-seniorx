...
public class Driver {
	...
	public int hashCode() {
		return Objects.hash(new Object[] { this.id, this.name, this.requestIntervalTime, this.waitInterval,
				this.sendCardholders, this.packetSize, this.extensibleConfiguration });
	}
