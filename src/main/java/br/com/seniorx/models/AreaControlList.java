...
public class AreaControlList {
	...
	public int hashCode() {
		return Objects.hash(new Object[] { this.id, this.gmt, this.useDaylightSaving, this.startDaylightSaving,
				this.endDaylightSaving, this.daylightSavingOffset, this.checkLevel, this.checkAntiPassback,
				this.checkCapacity, this.checkAccessCredit, this.checkAccessLevel, this.checkTimezoneLocation,
				this.checkAccessLevelAuthorizer, this.checkLocationAuthorizer, this.antiPassbackTime });
	}
	...
	public String toString() {
		...
		sb.append("    checkAccessLevelAuthorizer: ").append(toIndentedString(this.checkAccessLevelAuthorizer))
				.append("\n");
