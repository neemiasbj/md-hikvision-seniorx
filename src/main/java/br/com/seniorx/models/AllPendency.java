 ...
 public class AllPendency
 {
   ...
   public int hashCode() {
     return Objects.hash(new Object[] { this.deviceStatus, this.deviceDateTime, this.resetDevice, this.blockDevice, this.unblockDevice, this.setDeviceEmergency, this.unsetDeviceEmergency, this.apolloIncludeCard, this.apolloExcludeCard, this.includeBiometry, this.excludeBiometry, this.device, this.loadHolidayList, 
           this.removeHolidayList, this.activateDeviceOutput, this.deactivateDeviceOutput, this.datamartUpdated, this.personLocationUpdated, this.collectEvent, this.inputStatus, this.manufacturerUpdated, this.updatePersonREP, this.loadAllowCardList, this.removeAllowCardList, this.loadBiometryList, 
           this.removeBiometryList, this.includeCard, this.excludeCard, this.deviceDisplayMessage, this.updateFirmware, this.includePhoto, this.excludePhoto, this.loadCredentialFacialList });
   }
   ...
   public String toString() {
     ...
     sb.append("    loadCredentialFacialList: ").append(toIndentedString(this.loadCredentialFacialList)).append("\n");
     sb.append("}");
     return sb.toString();
   }
